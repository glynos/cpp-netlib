...
#ifndef NETWORK_PROTOCOL_HTTP_IMPL_HTTP_SYNC_CONNECTION_20100601
...
struct http_sync_connection : public virtual sync_connection_base<Tag, version_major, version_minor>, sync_connection_base_impl<Tag, version_major, version_minor> {
  ...
  void read_headers(basic_response<Tag> & response, asio::streambuf & response_buffer) {
...
#endif // NETWORK_PROTOCOL_HTTP_IMPL_HTTP_SYNC_CONNECTION_20100
