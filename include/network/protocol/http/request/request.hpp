...
struct request : request_base {
  ...
  virtual void get_body(std::function<void(boost::iterator_range<char const *>)> chunk_reader, size_t size) const;
  ...
  virtual void get_body(std::function<void(char*, size_t)> chunk_reader) const;
