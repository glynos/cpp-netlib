        ...
        namespace io {
          ...
          namespace detail {
            ...
            struct state : public boost::network::utils::base64::state<Value> {
              ...
              state(std::basic_ostream<Char> &output)
                  : super_t(), output(output) {
            ...
            std::basic_ostream<Char> &operator<<(
              ...
              base64::encode(input.begin, input.end,
          ...
          encode(InputRange const &value) {
            typedef typename boost::range_const_iterator<InputRange>::type
                InputIterator;
          ...
          inline detail::input_wrapper<char const *> encode(char const *value) {
            return detail::input_wrapper<char const *>(value,
                                                       value + strlen(value));
          }
          ...
          std::basic_ostream<Char> &encode_rest(
              std::basic_ostream<Char> &output) {
          ...
          template <typename Value, typename Char>
          std::basic_ostream<Char> &clear_state(
              std::basic_ostream<Char> &output) {
            detail::state<Char, Value> rest(output);
            rest.clear();
            return output;
