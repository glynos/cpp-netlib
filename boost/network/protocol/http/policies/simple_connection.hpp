       ...
       protected:
            ...
            do {
              ...
              if (follow_redirect_) {
                ...
                if (status >= 300 && status <= 307) {
                  ...
                  typename range_iterator<typename headers_range<
                      http::basic_response<Tag> >::type>::type location_header =
                      boost::begin(location_range);
        ...
        connection_ptr get_connection(
          ...
          connection_ptr connection_(new connection_impl(
              ...
              timeout_, certificate_filename, verify_path, certificate_file,
              private_key_file));
          return connection_;
        }
