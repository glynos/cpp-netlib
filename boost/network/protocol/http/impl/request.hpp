  ...
  namespace network {
    ...
    namespace http {
       ...
       public:
        ...
        port_type port() const {
          ...
          if (!port) {
            ...
            return boost::iequals(uri_.scheme(), string_type(consts::https()))
                       ? 443
                       : 80;
          }
          return *port;
      ...
      template <class Tag> struct not_quite_pod_request_base {
        ...
        typedef typename vector<Tag>::template apply<header_type>::type
            vector_type;
      ...
      template <>
      struct
          basic_request<tags::http_async_server> : not_quite_pod_request_base<
                                                       tags::
                                                           http_async_server> {
      };
      ...
      BOOST_CONCEPT_ASSERT(
          (ServerRequest<basic_request<tags::http_async_server> >));
      ...
      namespace impl {
        ...
        template <> struct request_headers_wrapper<tags::http_server> {
          ...
          request_headers_wrapper(
              basic_request<tags::http_server> const& request_)
              : request_(request_) {}
          typedef headers_container<tags::http_server>::type
