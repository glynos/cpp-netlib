...
public:
  ...
  boost::tuple<boost::tribool, InputIterator> parse_headers(request_pod & req,
...
private:
  ...
  boost::tribool consume(request_pod & req, char input);
...
typedef basic_request_parser<tag::default_> request_parser;
