  ...
  namespace network {
    namespace http {
      ...
      template <class Tag, class Handler> struct server_options {
        ...
        server_options &context(
            boost::shared_ptr<boost::asio::ssl::context> v) {
          context_ = v;
          return *this;
        }
        server_options &io_service(
            boost::shared_ptr<boost::asio::io_service> v) {
          io_service_ = v;
          return *this;
        }
        ...
        boost::optional<boost::asio::socket_base::send_buffer_size>
