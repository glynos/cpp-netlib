    ...
    namespace http {
      namespace impl {
        ...
        struct async_connection_base {
          typedef async_connection_base<Tag, version_major, version_minor>
              this_type;
          ...
          typedef function<
              void(char_const_range const &, system::error_code const &)>
          ...
          static connection_ptr new_connection(
              ...
              bool follow_redirect, bool always_verify_peer, bool https,
              int timeout, optional<string_type> certificate_filename =
