    ...
    namespace http {
      ...
      namespace impl {
        ...
        struct sync_client
          ...
          typedef typename connection_policy<
              Tag, version_major, version_minor>::type connection_base;
          ...
          basic_response<Tag> request_skeleton(
              basic_request<Tag> const& request_, string_type method,
