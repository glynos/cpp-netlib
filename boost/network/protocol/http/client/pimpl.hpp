  ...
  namespace network {
    namespace http {
      ...
      struct basic_client_impl
        ...
        typedef typename impl::client_base<Tag, version_major,
                                           version_minor>::type base_type;
        ...
        basic_client_impl(bool cache_resolved, bool follow_redirect,
                          ...
                          int timeout)
            : base_type(cache_resolved, follow_redirect, always_verify_peer,
                        timeout, service, certificate_filename, verify_path,
