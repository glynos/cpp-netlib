  ...
  namespace network {
    ...
    namespace impl {
      ...
      inline typename enable_if<
          mpl::and_<mpl::not_<is_pod<Tag> >, mpl::not_<is_async<Tag> > >,
          void>::type
      ...
      template <class Message, class Tag>
      inline typename enable_if<
          mpl::and_<mpl::not_<is_pod<Tag> >, is_async<Tag> >, void>::type
      clear_headers(Message const &message, Tag const &) {
        boost::promise<typename Message::headers_container_type> header_promise;
        boost::shared_future<typename Message::headers_container_type>
            headers_future(header_promise.get_future());
