...
namespace boost {
  namespace network {
    namespace uri {
      ...
      class BOOST_URI_DECL uri {
       ...
       public:
        ...
        const_range_type fragment_range() const {
          return uri_parts_.fragment ? uri_parts_.fragment.get()
                                     : const_range_type();
        }
      ...
      inline uri::string_type user_info(const uri &uri_) {
      ...
      inline uri::string_type fragment(const uri &uri_) {
...
namespace boost {
  namespace network {
    namespace uri {
      ...
      inline uri from_parts(const uri &base_uri,
