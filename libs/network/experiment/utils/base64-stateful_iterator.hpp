  ...
  namespace network {
    namespace utils {
      ...
      namespace base64_stateful_iterator {
        ...
        OutputIterator encode(InputIterator begin, InputIterator end,
                              OutputIterator output, State& rest) {
          typedef boost::iterator_with_state<InputIterator, State>
              stateful_input;
          // declare the encoding iterator type
          typedef base64_from_binary<
              stateful_transform_width<stateful_input, 6, 8> > base64_input;
        ...
        OutputIterator encode_rest(OutputIterator output, State& rest) {
          ...
          if (padding_length > 0) {
            ...
            typedef boost::iterator_with_state<
                typename pillow_input::const_iterator, State> stateful_input;
            // declare the encoding iterator type
            typedef base64_from_binary<
                stateful_transform_width<stateful_input, 6, 8> > base64_input;
